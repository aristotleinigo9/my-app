  ...
  //     coursesName: "Computer Literacy & Online Security Essentials",
  //     courseInfo: [
  //       {
  //         description: "This covers essential concepts and skills relating to computer devices, file management, networks, information, and online security. Learners are expected to use Microsoft (MS) Office programs for business and personal use.",
  //         learners: "APNE, VCGNE (30 hrs)",
  //       },
  //     ],
  //   },
